    ...
    <div class="user">
        ...
        <q-dialog v-model="logoutDialogVisible" persistent>
            <q-card style="min-width: 350px">
              ...
              <q-card-actions class="q-pt-none" style="justify-content: space-between;">
                <q-btn label="Cancel" @click="logoutDialogVisible = false" color="grey" style="flex: 1; margin-right: 10px;" />
                <q-btn label="Log Out" @click="handleLogout" color="primary" style="flex: 1; margin-left: 10px;" />
              </q-card-actions>
            </q-card>
        </q-dialog>
    </div>
